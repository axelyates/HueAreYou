...
import com.example.ayates2.hueareyou.HueSharedPreferences;
import com.example.ayates2.hueareyou.AccessPointListAdapter;
...
public class PHHomeActivity extends Activity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phHueSDK.setAppName("@string/app_name");
